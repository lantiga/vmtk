...
vtkvmtkGeodesicActiveContourLevelSet2DImageFilter::vtkvmtkGeodesicActiveContourLevelSet2DImageFilter()
{
...
void vtkvmtkGeodesicActiveContourLevelSet2DImageFilter::SimpleExecute(vtkImageData *input, vtkImageData *output)
{
  ...
  vtkvmtkITKFilterUtilities::VTKToITKImage2D<ImageType>(this->FeatureImage,featureImage);
  vtkvmtkITKFilterUtilities::VTKToITKImage2D<ImageType>(this->SpeedImage,speedImage);

  typedef itk::GeodesicActiveContourLevelSetImageFilter<ImageType,ImageType> ImageFilterType;
