...
void vtkvmtkFastMarchingUpwindGradientImageFilter::SimpleExecute(vtkImageData *input, vtkImageData *output)
{
  ...
  typedef itk::FastMarchingUpwindGradientImageFilter<ImageType,ImageType> ImageFilterType;
  ...
  if (this->TargetReachedMode == NO_TARGETS) {
    imageFilter->SetTargetReachedModeToNoTargets();
  }
  else if (this->TargetReachedMode == ONE_TARGET) {
