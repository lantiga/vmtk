...
#ifndef __vtkvmtkITKImageToImageFilterF2F2_h
#define __vtkvmtkITKImageToImageFilterF2F2_h
...
class VTK_VMTK_ITK_EXPORT vtkvmtkITKImageToImageFilterF2F2 : public vtkvmtkITKImageToImageFilter
{
public:
  vtkTypeMacro(vtkvmtkITKImageToImageFilterF2F2,vtkvmtkITKImageToImageFilter);
  static vtkvmtkITKImageToImageFilterF2F2* New() { return 0; };
...
protected:
  ...
  vtkvmtkITKImageToImageFilterF2F2 ( GenericFilterType* filter ) : vtkvmtkITKImageToImageFilter ()
  {
...
///     append->DebugOn();
  ...
  ~vtkvmtkITKImageToImageFilterF2F2()
  {
...
private:
  vtkvmtkITKImageToImageFilterF2F2(const vtkvmtkITKImageToImageFilterF2F2&);  /// Not implemented.
  void operator=(const vtkvmtkITKImageToImageFilterF2F2&);  /// Not implemented.
};
